...
def test_equal_elements_and_order(list_with_equal_elements_equal_order):
    """
    Test validate_sublists function with lists having the same elements
    in the same order.

    Asserts that the function returns True for lists with identical elements
    and order.
...
def test_unequal_elements(list_with_unequal_elements):
    """
...
def test_unequal_elements_and_unbalance(
    ...
    """
    Test validate_sublists function with lists having different elements and
    varying lengths.
